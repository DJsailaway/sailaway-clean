    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "20px", fontSize: "0.95rem" }}>
          ...
          <a href="/boat-storage-st-anthony" style={{ textDecoration: "none", color: "#333" }}>Boat Storage</a>
          <a href="/moorings-gillan-creek" style={{ textDecoration: "none", color: "#333" }}>Moorings</a> {/* new link */}
